                    ...
                    val rn = Runnable {
                        ...
                        (application as FlashApplication).smsBroadcastReceiver.setListener(object : SmsBroadcastReceiver.Listener {
                            override fun onTextReceived(sender: String, body: String) {
                                ...
                                value["msg"] = body
                                value["phone"] = sender
                                value["name"] = SmsUtils.getContactbyPhoneNumber(applicationContext, sender)
...
//                val c = MergeCursor(arrayOf(inbox, sent)) // Attaching inbox and sent sms
                ...
                val c = contentResolver.query(uriAll, null, "address IS NOT NULL) GROUP BY (thread_id", null, "date desc") // 2nd null = "address IS NOT NULL) GROUP BY (address"
